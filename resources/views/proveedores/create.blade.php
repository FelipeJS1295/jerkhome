...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 text-light">Nuevo Proveedor</h1>
    </div>
    ...
    <div class="card bg-dark text-light shadow rounded">
        <div class="card-body">
            <form action="{{ route('proveedores.store') }}" method="POST">
                ...
                <div class="form-group mb-3">
                    <label for="contacto" class="form-label" style="background-color: #343a40; padding: 5px 10px; border-radius: 5px;">Contacto</label>
                    <input type="text" class="form-control bg-secondary text-light" id="contacto" name="contacto" required>
                </div>
